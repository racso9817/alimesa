"""
Django settings for Alimesa project.
...
SECRET_KEY = 'u)0onm*+z3vlad4izjn%duhyttt75@8lltsi=z4+r_e!ujbb&6'
...
WSGI_APPLICATION = 'Alimesa.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'Camaron/static')
STATIC_URL = '/static/'
